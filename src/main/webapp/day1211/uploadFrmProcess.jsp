  ...
  ================================================== -->
      ...
      <div class="container marketing">
         ...
         <div class="row featurette">
            <div class="col-md-7">
               <%-- <%
               // enctype = "multipart/form-data" 일 때에는 기존 방식으로 web parameter 처리가 될 수 없다.
               // => 파일 업로드 컴포넌트를 사용
               String upload = request.getParameter("uploader");
               %>
               <%= upload %>, ${ param.uploader } --%>
               <%
               ...
               // 3. FileUpload 객체 (MultipartRequest) 생성 => 생성시 즉시 업로드
               MultipartRequest mr = new MultipartRequest(request, saveDir.getAbsolutePath(), uploadSize, 
               ...
               <c:choose>
               	<c:when test="${ flag }">
               		파일은 최대 10Mbyte (10,485,760) 까지만 업로드 가능합니다.
               	</c:when>
               	<c:otherwise>
