...
.toDayTd {background-color: #BACEE0; border: 1px solid #C7C8C9;}
</style>
<!-- jQuery CDN 시작 -->
		...
		<div class="container marketing">
			...
			<div class="row featurette">
				<div class="calWrap">
					...
					.append(cal.get(Calendar.MONTH)).append(cal.get(Calendar.DAY_OF_MONTH));
					...
					if (paramMonth != null) { // web parameter가 존재하면
						// Calendar 객체는 월을 0월 - 11월 12달을 사용
						// 10월이 입력되면 자바는 11월
							...
							<tbody>
								<tr>
									...
									for (int tempDay = 1; ; tempDay++) {
										...
										if (flagDate.toString().equals(cal.get(Calendar.YEAR) + "" + cal.get(Calendar.MONTH) + tempDay)) {
											toDayTd = " toDayTd";
										}// end if
