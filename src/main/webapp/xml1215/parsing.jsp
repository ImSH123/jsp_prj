		...
		$.ajax({
			...
			success : function(xmlDoc) {
				...
				$(xmlDoc).find("dept").each(function(i, deptNode) {
					...
					"<td>" + $(deptNode).find("deptname").text() + "</td>" + "</tr>";
  ...
  ================================================== -->
      ...
      <div class="container marketing">
         ...
         <div class="row featurette">
            <div class="col-md-7">
	            <div>
	               <input type="button" value="xml 요청" class="btn btn-info btn sm" id="btn"/>
	               <input type="text" name="name" id="name" placeholder="이름"/>
	               <input type="text" name="age" id="age" placeholder="나이"/>
	               <input type="text" name="addr" id="addr" placeholder="주소"/>
	            </div>
	            <div>
	               <input type="button" value="xml 요청2" class="btn btn-info btn sm" id="btn2"/>
