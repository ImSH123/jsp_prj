...
<!-- 공통디자인 외부 파일방식으로 사용 -->
<link rel="stylesheet" type="text/css" href="http://192.168.10.85/html_prj/common/css/main_v251031.css"/>
...
<div id="joinFrmDiv">
   <form name="joinFrm" id="joinFrm" action="getParameterFormProcess.jsp" method="get">
   <table id="joinFrm">
      <tr>
   ...
   <hr>
   <form name="joinFrm2" id="joinFrm2" action="getParameterFormProcess.jsp" method="post">
   <table id="joinFrm">
      <tr>
         <td class="title"><label><span class="star">*</span>아이디</label></td>
         <td class="input"><input type="text" class="inputBox" name="id" value="testsdfg"/></td>
